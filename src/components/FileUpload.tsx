    ...
    switch (fileType) {
      case 'depot':
        if (!('X' in firstRow && 'Y' in firstRow)) {
          toast.error('File depot harus memiliki kolom X dan Y');
          return false;
        }
        break;
      case 'customer':
        if (!('X' in firstRow && 'Y' in firstRow && 'Demand' in firstRow)) {
          toast.error('File pelanggan harus memiliki kolom X, Y, dan Demand');
          return false;
        }
        break;
      case 'vehicle':
